...
@section('content')
    <div class="container mx-auto px-6 mt-20 bg-white dark:bg-gray-900 pb-4 rounded-md min-h-screen">
      ...
      <div class="flex flex-col space-y-4">
        <!-- Post 1 -->
        <div class="bg-gray-100/50 dark:bg-gray-800 border-2 border-transparent hover:border-blue-700 transition-colors duration-300 rounded-lg shadow-md overflow-hidden">

          <div class="p-6">
            <h2 class="text-xl font-semibold text-gray-800 dark:text-gray-200 mb-2">Post Title 1</h2>
            <p class="text-gray-600 dark:text-blue-300">This is a short description of the post. It provides a brief overview of the content.</p>
          </div>
        </div>
