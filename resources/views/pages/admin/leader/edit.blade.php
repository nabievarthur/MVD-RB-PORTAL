            ...
            <form action="{{ route('admin.leader.update', $leader->id) }}" method="POST"
                ...
                <div>
                    ...
                    >
                        ...
                        <option value="minister" {{$leader->priority === 'Министр внутренних дел' ? "selected" : ""}}>
                            Министр
                        </option>
                        <option
                            value="deputy_minister" {{$leader->priority === 'Заместитель министра' ? "selected" : ""}}>
                            Заместитель министра
                        </option>
                        <option
                            value="deputy_police_chief" {{$leader->priority === 'Заместитель начальника полиции' ? "selected" : ""}}>
                            Заместитель начальника полиции
                        </option>
                        <option
                            value="department_head" {{$leader->priority === 'Начальник управления и прочее' ? "selected" : ""}}>
                            Прочее
                        </option>
                    </select>
                    @error('priority')
