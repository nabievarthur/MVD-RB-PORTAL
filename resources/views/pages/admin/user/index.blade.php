...
@section('content')
    <div class="flex w-full">
        ...
        <div class="w-1/3 bg-gray-800 rounded-lg shadow-md ml-4 mt-4 mb-4 p-4 overflow-auto">
            <h2 class="text-xl font-bold text-gray-200 text-center">Создание нового пользователя</h2>
                    ...
                    @forelse($users as $user)
                        <tr class="border-b border-gray-600 hover:bg-gray-600 transition-colors">
                            ...
                            <td class="py-3 px-4 space-x-2 flex">
                                ...
                                <button
                                    onclick="openModal('{{ route('admin.user.destroy', $user->id) }}', 'этого пользователя')"
