@auth
    @php
        ...
        $fio = empty(auth()->user()->last_name) ? "Не указано " : auth()->user()->last_name . " ";
        $fio .= empty(auth()->user()->first_name) ? "Не указано " : auth()->user()->first_name . " " ;
        $fio .= empty(auth()->user()->surname) ? "Не указано" : auth()->user()->surname ;
                    ...
                    @if(auth()->user()->isAdmin())
                        <a href="{{route('admin.index')}}">
                            <svg xmlns="http://www.w3.org/2000/svg" width="15" height="15" fill="currentColor"
                                 class="text-blue-700 cursor-pointer w-6 h-6 bi bi-gear" viewBox="0 0 16 16">
                                <path
