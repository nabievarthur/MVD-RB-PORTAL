    ...
    <div class="container sm:w-11/12 mx-auto flex items-center justify-between mx-auto p-4">
        ...
        <div class="absolute left-1/2 transform -translate-x-1/2">
            <div class="flex items-center justify-between" id="navbar-sticky">
                <ul class="flex flex-col p-4 md:p-0 mt-4 font-medium border border-gray-100 rounded-lg bg-gray-50 space-x-6 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
                    @auth
                        <li>
                            <x-nav-link
                                route="home"
        ...
        <div class="flex order-2 space-x-3 items-center">
            <div>
                <button id="theme-toggle" class="cursor-pointer">
                    <svg id="moon-icon" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" stroke="currentColor" stroke-width="2"
                         stroke-linecap="round" stroke-linejoin="round" class="text-blue-700 feather feather-moon">
                        <path d="M21 12.79A9 9 0 1 1 11.21 3a7 7 0 0 0 9.79 9.79z"/>
                    </svg>

                    <svg id="sun-icon" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" stroke="currentColor" stroke-width="2"
                         stroke-linecap="round" stroke-linejoin="round" class="text-blue-700 feather feather-sun">
            ...
            <div>
                ...
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="text-blue-700 cursor-pointer w-6 h-6 bi bi-gear" viewBox="0 0 16 16">
